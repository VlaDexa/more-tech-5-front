...
export default function Map() {
    ...
    useEffect(() => {
        if (!navigator.geolocation) {
            ...
            navigator.geolocation.getCurrentPosition((position) => { setPosition([position.coords.latitude, position.coords.longitude]) }, () => { });
        }
    }, []);
    ...
    return <YMap defaultState={{ center: position, zoom: 9 }} className="w-full h-full p-4" instanceRef={mapRef}></YMap>;
}